"""CSV import endpoints for companies (accounts).
...
non-privileged members cannot mass-create accounts through this surface.
"""
...
from accounts.services.csv_import import commit_rows, parse_and_validate
...
class AccountImportPreviewView(APIView):
    ...
    @extend_schema(
        ...
        request=inline_serializer(
            name="AccountImportPreviewRequest",
            fields={"file": serializers.FileField()},
        ),
        responses={
            200: inline_serializer(
                name="AccountImportPreviewResponse",
                fields={
...
class AccountImportCommitView(APIView):
    ...
    @extend_schema(
        tags=["accounts"],
        request=inline_serializer(
            name="AccountImportCommitRequest",
            fields={"file": serializers.FileField()},
        ),
        responses={
            200: inline_serializer(
                name="AccountImportCommitResponse",
                fields={
