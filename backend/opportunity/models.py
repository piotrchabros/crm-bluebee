...
class Opportunity(AssignableMixin, BaseModel):
    ...
    # AI Offer Integration. Post-cutover (Feature 4) offers are generated by the
    # native `offers` app and linked via the `offer` FK below; `offer_id` is the
    # legacy int id from the old bluebee.marketing proxy, kept for old records.
    offer_brand = models.CharField(
        _("Offer Brand"),
        max_length=16,
        choices=(("bluebee", "BlueBee"), ("bespoke", "BespokeSoft")),
        default="bespoke",
        help_text="Waypoint that selects the offer theme/branding (BlueBee dark / BespokeSoft light).",
    )
    generated_offer = models.ForeignKey(
        "offers.Offer",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="+",
        help_text="Native generated offer (Feature 4).",
    )
    offer_id = models.IntegerField(
        _("Offer ID (legacy)"),
        null=True,
        blank=True,
        help_text="Legacy int id from the old bluebee.marketing proxy.",
    )
    offer_url = models.URLField(
        ...
        null=True,
        blank=True,
        help_text="Ready-to-send public link to the generated offer page.",
    )
    offer_status = models.CharField(
        ...
        null=True,
        blank=True,
        help_text="generated / editing / error",
    )
