          ...
          <div class="relative flex flex-col gap-8 md:flex-row md:items-start">
            ...
            <div class="flex flex-col items-center gap-4">
              <div class="relative">
                ...
                <!-- Avatar container -->
                <div
                  class="org-avatar relative flex h-28 w-28 items-center justify-center rounded-2xl bg-gradient-to-br from-[var(--accent-primary)] to-[var(--accent-secondary)] shadow-2xl"
                >
